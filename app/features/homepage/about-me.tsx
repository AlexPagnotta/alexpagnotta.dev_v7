    ...
    <section className="px-24">
      <Container size="md" className="py-60 lg:py-80">
        <h2 className="display flex flex-wrap items-center justify-center gap-12 text-center lg:gap-24">
          ...
          <span
            aria-hidden="true"
            className="size-48-px shrink-0 rounded-full border-2 bg-[#d9d9d9] shadow-depth-sm lg:size-96-px lg:border-4"
          />
        </h2>
        <div className="mt-40 flex flex-col justify-between gap-40 lg:mt-60 lg:flex-row lg:gap-110">
          ...
          <div className="flex justify-center gap-24 lg:shrink-0 lg:flex-col lg:gap-110">
            <div className="h-[180px] w-full max-w-[205px] rotate-[-8deg] rounded-sm bg-[#efefef] lg:w-[205px]" />
            <div className="h-[180px] w-full max-w-[210px] rotate-3 rounded-sm bg-[#d9d9d9] lg:w-[210px]" />
          </div>
        </div>
      </Container>
    </section>
